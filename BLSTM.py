...
from models import BLSTM_wf_lstm, BLSTM_wf_b4_sec, BLSTM_wf_after_sec
...
output_folder = 'word_feats_after_secret'
...
def train():
    ...
    model = BLSTM_wf_after_sec(vocab_size, embed_size, hidden_size, output_size, extra_hidden_size, feat_length=word_feats.sparse_length())
...
def test():
    ...
    model = BLSTM_wf_after_sec(sta["vocab_size"], sta["embed_size"], sta["hidden_size"], output_size, extra_hidden_size, feat_length=word_feats.sparse_length())
